...
Cohesion: 0.22
Nodes (2): HomePointScreen, _HomePointScreenState
...
- **Thin community `Community 18`** (2 nodes): `HafalanDetailScreen`, `_HafalanDetailScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `HafalanScreen`, `_HafalanScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 11`** (2 nodes): `HafalanSubmitScreen`, `_HafalanSubmitScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (2 nodes): `HomePointScreen`, `_HomePointScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 27`** (2 nodes): `KhatmilLeaderboardScreen`, `_KhatmilLeaderboardScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (2 nodes): `KhatmilManualProgressScreen`, `_KhatmilManualProgressScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 23`** (2 nodes): `NotificationScreen`, `_NotificationScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 12`** (2 nodes): `ProfileScreen`, `_ProfileScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 7`** (2 nodes): `QuranReaderScreen`, `_QuranReaderScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 29`** (2 nodes): `TanyaScreen`, `_TanyaScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 5`** (2 nodes): `TanyaThreadScreen`, `_TanyaThreadScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (2 nodes): `VisitChatScreen`, `_VisitChatScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 8`** (2 nodes): `VisitScheduleScreen`, `_VisitScheduleScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `VisitScreen`, `_VisitScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 3`** (2 nodes): `VisitStatusScreen`, `_VisitStatusScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (2 nodes): `WalletScreen`, `_WalletScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 10`** (2 nodes): `DataUstadzScreen`, `_DataUstadzScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (2 nodes): `KhatmilBinaanDetailScreen`, `_KhatmilBinaanDetailScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (2 nodes): `KhatmilUstadzScreen`, `_KhatmilUstadzScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (2 nodes): `PayoutScreen`, `_PayoutScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 13`** (2 nodes): `SetoranReviewScreen`, `_SetoranReviewScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `SetoranScreen`, `_SetoranScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `UstadzWalletScreen`, `_UstadzWalletScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `VisitIncomingScreen`, `_VisitIncomingScreenState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
