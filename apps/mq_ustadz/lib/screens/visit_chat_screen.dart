...
/// Chat kunjungan sisi ustadz (pola sama dgn santri — bubble + polling 5s).
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (e.toString().contains('403')) msg = 'Chat hanya aktif saat kunjungan dikonfirmasi';
        ...
        children: [
          if (!_loading && !_chatOpen)
            Container(
              ...
              child: const Text(
                'Chat hanya bisa dikirim saat kunjungan berstatus dikonfirmasi. Riwayat tetap bisa dibaca.',
